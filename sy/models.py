...
class FiscalYearsPeriodsModules(models.Model):
    ...
    closedate = models.CharField(max_length=255, null=True)
...
class PaymentsTearms(models.Model):
    ...
    # accounttype = models.ForeignKey(LookUp,related_name='PaymentsTearms_AccountType', limit_choices_to={'keyname': '"AccountType"'}, blank=True, null=True, on_delete=models.PROTECT, verbose_name=_("Account Type"))
    accounttype = models.ForeignKey(LookUp,related_name='PaymentsTearms_AccountType', limit_choices_to=Q(keyid= 90015) | Q(keyid=90002) | Q(keyid=90003), blank=True, null=True, on_delete=models.PROTECT, verbose_name=_("Account Type"))
...
class CashDiscountsRoles(models.Model):
    ...
    # accounttype = models.ForeignKey(LookUp,related_name='CashDiscountsRoles_AccountType', limit_choices_to={'keyname': '"AccountType"'}, blank=True, null=True, on_delete=models.PROTECT, verbose_name=_("Account Type"))
    accounttype = models.ForeignKey(LookUp,related_name='CashDiscountsRoles_AccountType', limit_choices_to=Q(keyid= 90015) | Q(keyid=90002) | Q(keyid=90003), blank=True, null=True, on_delete=models.PROTECT, verbose_name=_("Account Type"))
...
class Taxes(models.Model):
    ...
    def __str__(self):
        ...
        if get_language() == 'ar':
            ...
            # return self.code + ' - ' + self.engname
            return "%s%s"%(self.code,self.engname)
