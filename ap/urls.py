...
#vendors Categories
    ...
    path('vendorscategories/delete/',views.deletevendorscategories, name="delete_vendorscategories"),
...
#vendors Classes
    ...
    path('vendorsclasses/delete/',views.deletevendorsclasses, name="delete_vendorsclasses"),
...
#Vendor
    ...
    path('vendors/delete/',views.deletevendors, name="delete_vendors"),
...
#buyersgroups
    ...
    path('buyersgroups/delete/',views.deletebuyersgroups, name="delete_buyersgroups"),
...
#buyers
    ...
    path('buyers/delete/',views.deletebuyers, name="delete_buyers"),
...
#Vendor Jour
    ...
    path('vendorsjour/delete/',views.deletevendorsjour, name="delete_vendorsjour"),
